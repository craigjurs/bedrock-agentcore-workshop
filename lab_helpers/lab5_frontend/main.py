...
from utils import get_redcross_chatbot_secret

secret = get_redcross_chatbot_secret()
...
st.title("American Red Cross Customer Service Chatbot")
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            message_placeholder.markdown(
                '<span class="thinking-bubble">🤖 💭 American Red Cross Assistant is thinking...</span>',
            ...
            for chunk in invoke_endpoint_streaming(
                ...
                if chunk.strip():  # Only process non-empty chunks
                    ...
                    if '"End agent execution"' in accumulated_response:
                        ...
                        message_placeholder.markdown(
                            '<span class="thinking-bubble">🤖 🔄 Processing your request...</span>',
                            unsafe_allow_html=True,
                        )
