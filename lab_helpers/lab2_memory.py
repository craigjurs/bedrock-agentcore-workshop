...
def delete_memory(memory_hook):
    try:
        ...
        ssm_client.delete_parameter(Name="/app/redcross/agentcore/memory_id")
    except Exception:
        pass
...
class RedCrossChatbotMemoryHooks(HookProvider):
        ...
        if (
            ...
            try:
                ...
                for context_type, namespace in self.namespaces.items():
                    # *** AGENTCORE MEMORY USAGE *** - Retrieve user context from each namespace
        ...
        try:
            ...
            if len(messages) >= 2 and messages[-1]["role"] == "assistant":
                ...
                if user_query and agent_response:
                    # *** AGENTCORE MEMORY USAGE *** - Save the chatbot interaction
                    ...
                    logger.info("Saved chatbot interaction to memory")
    ...
    def register_hooks(self, registry: HookRegistry) -> None:
        ...
        logger.info("Red Cross chatbot memory hooks registered")
